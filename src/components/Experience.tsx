...
const experiences: ExperienceEntry[] = [
  ...
  {
    period: '2020–2022 гг.',
    title: 'Начальник отдела исследований и разработок',
    organization: 'ТрансЛинк',
    bullets: [
      'Запустил направление медиалокализации',
      'Внедрил системы машинного перевода в процессы организации',
      'Обучал сотрудников отдела продаж и производственного подразделения новым процессам',
      'Формировал базы знаний по новым направлениям',
      'Вел процессы внутреннего обучения от адаптации и цикличных тренингов до поиска принципиально новой экспертизы и формирования курсов повышения квалификации сотрудников',
    ],
  },
  {
    period: '2017–2020 гг.',
    title: 'Начальник отдела контроля качества',
    organization: 'ТрансЛинк',
    bullets: [
      'Руководил выпускающими редакторами компании',
      'Организовывал QA/QC для портала Welcome2018.com в рамках лингвистического сопровождения Кубка конфедераций 2017 и Чемпионата мира по футболу 2018',
      'Управлял командами локализации на проектах российских и зарубежных издателей',
      'Изучал и внедрял новые средства контроля качества и программное обеспечение в рамках производства',
      'Вел документацию Системы менеджмента качества',
      'Проводил внутренние аудиты и аудиты в дочерней компании',
      'Организовывал и сопровождал аудиты ISO',
    ],
  },
];
